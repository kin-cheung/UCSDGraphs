...
public class GraphAdjList extends Graph {
	 ...
	 */
	 public List<Integer> getDistance2(int v) {
		 ...
		 List<Integer> neigbors = adjListsMap.get(v);
		 for (Integer neigbor: neigbors) {
			 List<Integer> neigborsNeigbors = adjListsMap.get(neigbor);
			 twoHopNeighbors.addAll(neigborsNeigbors);
		 }
		 return twoHopNeighbors.stream().collect(Collectors.toList());
	}
